...
darkcave = input(
    "You are in a dark cave. You can see a light to the left. Choose 'left' or 'right'?")
if (darkcave == "left"):
    ...
    if (swim == "walk"):
        ...
        if (castle == "1"):
            ...
            if (sword == "sword"):
                ...
                if (light == "light"):
                    print(
                        "You walk towards the light. You see a treasure chest. Do you 'open' it or 'leave' it alone?")
                    chest = input("Which do you choose?")
                    if (chest == "open"):
                        print(
                            "You open the chest and found the treasure. Congratulations, You've won!")
                    else:
                        print(
                            "You leave the chest alone. You walk out of the room and guard catches you, You are imprisoned. You've lost")
                else:
                    print(
                        "You walk towards the other side. It is dark, you fell in a pit and die?")
            else:
            ...
            print(
                "You've entered the wrong room. There is a troll there. You fight him and die. You've lost")
    else:
